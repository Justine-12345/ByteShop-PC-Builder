...
{{--      @include('partials.admin_header') --}}
  ...
  {{--   @include('partials.admin_header2') --}}
                ...
                {{-- MODIFY START --}}
                                ...
                                <div class="col">
                                <h1 class="col text-center" style="color: white;margin-top: 10px;">{{ucwords($soliddrive->title)}} <br>{!!Star::display($review->review_rating)!!}</h1>
                                </div>
                                <div class="col text-center"><img style="color: rgb(133, 135, 150);border-radius: 5%;width: 300px;height: 300px;border: 10px solid #031131 ; margin: 20px;" src="{{$soliddrive->image != "" || $soliddrive->image != null? asset('src/images/products/'.$soliddrive->image):url('/noImg.png') }}" onerror="this.src='{{url('/noImg.png')}}'">
                                </div>
                        <form action="{{ route('product.addToCart', ['id'=>$soliddrive->item_id]) }}" method="GET">
                    @if($fromBuilder == null) 
                        <div class="row justify-content-center">
                                ...
                                <div class="spinner-control">
                                   <span style="margin-right: 5px">Qty: </span> 
                                        ...
                                        <input type="text" name="quantity" data-type="number" step="1" max="{{$soliddrive->quantity}}" min="1" value="1"  id="spinner1">
                                        ...
                                        <table class="table" style="text-align:center;">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="color: white;">{{ucwords($soliddrive->brand_name)}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Price</td>
                                                    <td style="color: white;">₱ {{ number_format($soliddrive->price, 2, '.', ',') }}</td>
                                                </tr>
                                                 <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="color: white;">{{$soliddrive->quantity}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Form Factor</td>
                                                    <td style="color: white;">{{$soliddrive->form_factor}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Interface</td>
                                                    <td style="color: white;">{{$soliddrive->interface}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Read Speed</td>
                                                    <td style="color: white;">{{$soliddrive->read_speed}} MBps</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Write Speed</td>
                                                    <td style="color: white;">{{$soliddrive->write_speed}} MBps</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Endurance Rating</td>
                                                    <td style="color: white;">{{$soliddrive->endurance_rating}} TBW</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">IOPS</td>
                                                    <td style="color: white;">{{$soliddrive->iops}} IOPS</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Capacity</td>
                                                    <td style="color: white;">{{Converter::translateS($soliddrive->capacity)}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Cell Type</td>
                                                    <td style="color: white;">{{$soliddrive->cell_type}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Description</td>
                                                    <td style="color: white;">{{$soliddrive->soliddrive_description}}</td>
                                                </tr>
                                            </tbody>
                                                                                       {{-- REVIEW START --}}
                                     <thead style="background: #031131;color: rgb(248,249,255);">
