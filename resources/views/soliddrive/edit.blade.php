    ...
    @include('partials.admin_header2')
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Edit Solid State Drive</h3>
                    </div>
                    <div style="background: rgb(230,247,236);padding: 11px;">
                        <h1 style="font-size: 23px;">Basic Info</h1>

                        <form method="post" action="{{ route('soliddrive.update', $soliddrive->item_id) }}" enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PATCH') }}
                            <div class="form-row">
                                        ...
                                        <select class="form-control" name="brand_id">
                                            <optgroup label="Brand Names">
                                                ...
                                                @foreach($brands as $brand)
                                                    @if( $soliddrive->brand_id == $brand->brand_id)
                                ...
                                <div class="col"><label style="color: rgb(0,0,0);">Title:</label>
                                    <div class="form-group">
                                        <input class="form-control" type="text" name="title" value="{{ $soliddrive->title }}">
                            ...
                            <div class="form-row">
                                <div class="col"><label style="color: rgb(0,0,0);">Stock:&nbsp;</label>
                                    <div class="form-group">
                                        <input class="form-control" type="number" min="1" max="1000000" step="1" placeholder="No. of Stocks" name="quantity" value="{{ $soliddrive->quantity }}">
                                ...
                                <div class="col"><label style="color: rgb(0,0,0);">Price:</label>
                                    <div class="form-group">
                                        <input class="form-control" type="number" name="price" value="{{ $soliddrive->price }}">
                        ...
                        {{-- OTHER INFO --}}
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Form Factor</label>
                                <div class="form-group"><select name="form_factor" class="form-control" >
                                    ...
                                    @else
                                    <option value="{{$soliddrive->form_factor}}" selected>{{$soliddrive->form_factor}}</option>
                                    @endif
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Interface</label>
                                <div class="form-group">
                                  <select name="interface" class="form-control" >
                                    ...
                                    @else
                                    <option value="{{$soliddrive->interface}}" selected>{{$soliddrive->interface}}</option>    
                                    @endif
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Read Speed (MB per second)</label>
                                 <div class="form-group">
                                        <input class="form-control" type="number" min="1" name="read_speed" value="{{old('read_speed')?old('read_speed'): $soliddrive->read_speed}}">
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Write Speed (MB per second)</label>
                                <div class="form-group">
                                        <input class="form-control" type="number" min="1" name="  write_speed" value="{{old('write_speed')?old('write_speed'):$soliddrive->write_speed}}">
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Endurance Rating (TBW - Terabytes Written)</label>
                                <div class="form-group">
                                        <input class="form-control" type="number" min="1" name="  endurance_rating" value="{{old('endurance_rating')?old('endurance_rating'):$soliddrive->endurance_rating}}">
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Input/Output Operations Per Second (IOPS)</label>
                                  <div class="form-group">
                                        <input class="form-control" type="number" min="1" name="iops" value="{{old('iops')?old('iops'): $soliddrive->iops}}">
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Capacity</label>
                                <div class="form-group">
                                     ...
                                     <select name="capacity" class="form-control" >
                                      ...
                                      @else
                                      <option value="{{$soliddrive->capacity}}">{{Converter::translateS($soliddrive->capacity)}}</option>
                                      @endif
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Cell Type</label>
                                 <div class="form-group">
                                    ...
                                    @else
                                    <option value="{{$soliddrive->cell_type}}"> {{$soliddrive->cell_type}} </option>
                                    @endif
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Solid Drive Description</label>
                                <div class="form-group">
                                        <input class="form-control" type="text" name="soliddrive_description" value="{{old('soliddrive_description')?old('soliddrive_description'): $soliddrive->soliddrive_description}}">
