...
<body id="page-top">
    <div id="wrapper">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Edit Oprerating System</h3>
                    </div>
                    <div style="background: rgb(230,247,236);padding: 11px;">
                        ...
                        <form method="post" action="{{ route('operatingsystem.update', $operatingsystems[0]->item_id) }}" enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PATCH') }}
                            ...
                            <div class="form-row">
                                        ...
                                        <select class="form-control" name="brand_id">
                                            <optgroup label="Brand Names">
                                                ...
                                                @foreach($brands as $brand)
                                                    @if( $operatingsystems[0]->brand_id == $brand->brand_id)
                                ...
                                <div class="col"><label style="color: rgb(0,0,0);">Title:</label>
                                    <div class="form-group">
                                        <input class="form-control" type="text" name="title" value="{{ $operatingsystems[0]->title }}">
                            ...
                            <div class="form-row">
                                <div class="col"><label style="color: rgb(0,0,0);">Stock:&nbsp;</label>
                                    <div class="form-group">
                                        <input class="form-control" type="number" min="1" max="1000000" step="1" placeholder="No. of Stocks" name="quantity" value="{{ $operatingsystems[0]->quantity }}">
                                ...
                                <div class="col"><label style="color: rgb(0,0,0);">Price:</label>
                                    <div class="form-group">
                                        <input class="form-control" type="number" name="price" value="{{ $operatingsystems[0]->price }}">
        ...
        {{--  ADD ADDITIONAL INPUTS HERE --}}
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Processor Speed (GHz):</label>
                                    <div class="form-group"><input class="form-control" type="number" name="processor_speed" step=".1" min=".1" max="8" value="{{old('processor_speed') ? old('processor_speed') : $operatingsystems[0]->processor_speed}}"></div>

                                     @if($errors->has('processor_speed'))
                                        <small><i style="color:red;">*{{ $errors->first('processor_speed') }}</i></small>
                                            @endif
                                        </div>
                          ...
                          <div class="col"><label style="color: rgb(0,0,0);">Memory Requirement:</label>
                                <div class="form-group">
                                 ...
                                 <option value="{{$operatingsystems[0]->memory_requirement}}"selected>{{$converter->translate($operatingsystems[0]->memory_requirement)}}</option>
                    ...
                    <div class="col"><label style="color: rgb(0,0,0);">Space Requirement:</label>
                                ...
                                <option value="{{$operatingsystems[0]->space_requirement}}" selected>{{$converter->translate($operatingsystems[0]->space_requirement)}}</option>
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Graphic card Requirement:</label>
                                <div class="form-group">
                                    @if($operatingsystems[0]->graphiccard_requirement == 'Microsoft DirectX 9')
                                    ...
                                    @elseif($operatingsystems[0]->graphiccard_requirement  == 'Greater graphics device with WDDM Driver')
                                        <div class="form-check form-check-inline">
