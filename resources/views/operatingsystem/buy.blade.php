...
{{--      @include('partials.admin_header') --}}
  ...
  {{--   @include('partials.admin_header2') --}}
                ...
                {{-- MODIFY START --}}
                                <div class="col">
                                <h1 class="col text-center" style="color: white;margin-top: 10px;">{{ucwords($operatingsystems[0]->title)}} <br>{!!Star::display($review->review_rating)!!}</h1>
                                </div>
                                <div class="col text-center"><img style="color: rgb(133, 135, 150);border-radius: 5%;width: 300px;height: 300px;border: 10px solid #031131 ; margin: 20px;" src="{{$operatingsystems[0]->image != "" || $operatingsystems[0]->image != null? asset('src/images/products/'.$operatingsystems[0]->image):url('/noImg.png') }}" onerror="this.src='{{url('/noImg.png')}}'">
                                </div>
                        <form action="{{ route('product.addToCart', ['id'=>$operatingsystems[0]->item_id]) }}" method="GET">
                    @if($fromBuilder == null)
                        <div class="row justify-content-center">
                                ...
                                <div class="spinner-control">
                                   <span style="margin-right: 5px">Qty: </span> 
                                        ...
                                        <input type="text" name="quantity" data-type="number" step="1" max="{{ $operatingsystems[0]->quantity }}" min="1" value="1"  id="spinner1">
                                        ...
                                        <table class="table" style="text-align:center">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="color: white;">{{ $operatingsystems[0]->brand_name }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Category</td>
                                                    <td style="color: white;">{{ $operatingsystems[0]->category_name }}</td>
                                                </tr>
                                                 <tr>
                                                ...
                                                <tr>
                                                    <td style="color: white;">Processor Speed</td>
                                                    <td style="color: white;">{{ $operatingsystems[0]->processor_speed }} Ghz</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Memory Requirement</td>
                                                    <td style="color: white;">
                                                        {{ $converter->translate($operatingsystems[0]->memory_requirement) }} 
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Space Requirement</td>
                                                    <td style="color: white;">{{ $converter->translate($operatingsystems[0]->space_requirement) }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Graphic card Requirement</td>
                                                    <td style="color: white;">{{ $operatingsystems[0]->graphiccard_requirement }}</td>
                                                </tr>
                                                 
                                                    <td style="color: white;">Stocks</td>
                                                    <td style="color: white;">{{ $operatingsystems[0]->quantity }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Price</td>
                                                    <td style="color: white;">₱ {{ number_format($operatingsystems[0]->price, 2, '.', ',') }}</td>
                                                </tr>
                                            </tbody>
                                                                                {{-- REVIEW START --}}
                                     <thead style="background: #031131;color: rgb(248,249,255);">
