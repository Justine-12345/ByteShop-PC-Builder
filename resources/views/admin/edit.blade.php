        ...
        <div class="form-group" id="upload_button">
             ...
             <img id="blah" src="{{asset('storage/profilePic/'.$user->image)}}" alt="your image" width="150" height="150"  style="display: none; object-fit:cover; border-radius: 50%; border:5px solid #5bc0de;" onload="this.style.display=''"
                    /><br><br>
                     ...
                     <label>
              <input type="file" name="picture"  onchange="document.getElementById('blah').src = window.URL.createObjectURL(this.files[0])" style="visibility: hidden;">

              <span class="btn btn-primary" style="position:relative; right:65px">Upload Profile</span>
            </label>
