    ...
    <div id="wrapper">
        ...
        @include('partials.admin_header2')
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Add Headphone</h3>
                    </div>
                    <div style="background: rgb(230,247,236);padding: 11px;">
                        <h1 style="font-size: 23px;">Basic Info</h1>
            {{-- START --}}
                        <form method="post" action="{{ route('headphone.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-row">
        ...
        {{--  ADD ADDITIONAL INPUTS HERE --}}
                                ...
                                <div class="col"><label style="color: rgb(0,0,0);">Frequency Response:&nbsp;</label>
                                    <div class="form-group">
                                        <input class="form-control" type="text" placeholder="No. of Frequency Response in Hz" name="frequency_response" value="{{old('frequency_response')}}">
                   ...
                   {{--      <div class="form-row">
                            <div class="col"><label style="color: rgb(0,0,0);">Transuder Principle:</label>
                                <div class="form-group">
                                   
                                     <select name="transducer_principle" class="form-control" >
                                    <option value="">Select Transuder Principle</option>
                               ...
                               <div class="col"><label style="color: rgb(0,0,0);">Transducer Principle:</label>
                                <div class="form-group">
                                    {{-- <input class="form-control" type="text" name="poll_rate" value="{{old('poll_rate')}}"> --}}
                                     ...
                                     <select name="transducer_principle" class="form-control" >
                                    <option value="">Select Transuder</option>
                                    <option value="Moving-coil dynamic">Moving-coil dynamic</option>
                                    <option value="Planar magnetic">Planar magnetic</option>
                                    <option value="Electrostatic">Electrostatic</option>
                                      <option value="Balanced armature">Balanced armature</option>
                                ...
                                <div class="col"><label style="color: rgb(0,0,0);">Nominal Impedence:&nbsp;</label>
                                    <div class="form-group">
                                        <input class="form-control" type="text" placeholder="No. of Ohms" name="nominal_impedance" value="{{old('nominal_impedance')}}">
                                ...
                                <div class="col"><label style="color: rgb(0,0,0);">Sensitivity:&nbsp;</label>
                                    <div class="form-group">
                                        <input class="form-control" type="text" placeholder="No. of dB" name="headphone_sensivity" value="{{old('headphone_sensivity')}}">
                               ...
                               <div class="col"><label style="color: rgb(0,0,0);">Weight (grams):</label>
                                <div class="form-group"><input class="form-control" type="text" name="weight" value="{{old('weight')}}"></div>
                            </div>
                    

                          
                            <div class="col"><label style="color: rgb(0,0,0);">Description:</label>
                                <div class="form-group"><input class="form-control" type="text" name="headphones_desciption" value="{{old('headphones_desciption')}}"></div>
                            </div>
