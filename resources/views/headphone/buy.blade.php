...
{{--      @include('partials.admin_header') --}}
  ...
  {{--   @include('partials.admin_header2') --}}
                ...
                {{-- MODIFY START --}}
                                <div class="col">
                                <h1 class="col text-center" style="color: white;margin-top: 10px;">{{ucwords($headphones[0]->title)}} <br>{!!Star::display($review->review_rating)!!}</h1>
                                </div>
                                <div class="col text-center"><img style="color: rgb(133, 135, 150);border-radius: 5%;width: 300px;height: 300px;border: 10px solid #031131 ; margin: 20px;" src="{{$headphones[0]->image != "" || $headphones[0]->image != null? asset('src/images/products/'.$headphones[0]->image):url('/noImg.png') }}" onerror="this.src='{{url('/noImg.png')}}'">
                                </div>
                        <form action="{{ route('product.addToCart', ['id'=>$headphones[0]->item_id]) }}" method="GET">
                    @if($fromBuilder == null)
                        <div class="row justify-content-center">
                                ...
                                <div class="spinner-control">
                                   <span style="margin-right: 5px">Qty: </span> 
                                        ...
                                        <input type="text" name="quantity" data-type="number" step="1" max="{{ $headphones[0]->quantity }}" min="1" value="1"  id="spinner1">
                    ...
                    @endif
                     ...
                     {{-- MODIFY END --}}
                            <div class="col">
                             ...
                             @endif 
                                    <div class="table-responsive" style="text-align: center;color: white;">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="color: white;">{{ $headphones[0]->brand_name }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Category</td>
                                                    <td style="color: white;">{{ $headphones[0]->category_name }}</td>
                                                </tr>
                                                 <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="color: white;">{{ $headphones[0]->frequency_response }} Hz</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Transducer Principle</td>
                                                    <td style="color: white;">{{ $headphones[0]->transducer_principle }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Driver Size</td>
                                                    <td style="color: white;">{{ $headphones[0]->driver_size }}mm</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Nominal Impedance</td>
                                                    <td style="color: white;">{{ $headphones[0]->nominal_impedance }}ohms</td>
                                                </tr>
                                                 <tr>
                                                    <td style="color: white;">Headphone Sensitivity</td>
                                                    <td style="color: white;">{{ $headphones[0]->headphone_sensivity}}dB</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Weight</td>
                                                    <td style="color: white;">{{ $headphones[0]->weight}} grams</td>
                                                </tr>
                                                
                                               
                                                <tr>
                                                    <td style="color: white;">Description</td>
                                                    <td style="color: white;">{{ $headphones[0]->headphones_desciption }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Stocks</td>
                                                    <td style="color: white;">{{ $headphones[0]->quantity }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Price</td>
                                                    <td style="color: white;">₱ {{ number_format($headphones[0]->price, 2, '.', ',') }}</td>
                                                </tr>
                                            </tbody>
                                                                             {{-- REVIEW START --}}
                                     <thead style="background: #031131;color: rgb(248,249,255);">
