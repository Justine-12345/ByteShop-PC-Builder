...
{{--      @include('partials.admin_header') --}}
  ...
  {{--   @include('partials.admin_header2') --}}
                ...
                {{-- MODIFY START --}}
                                ...
                                <div class="col">
                                <h1 class="col text-center" style="color: white;margin-top: 10px;">{{ucwords($videocards->title)}} <br>{!!Star::display($review->review_rating)!!}</h1>
                                </div>
                                <div class="col text-center"><img style="color: rgb(133, 135, 150);border-radius: 5%;width: 300px;height: 300px;border: 10px solid #031131 ; margin: 20px;" src="{{$videocards->image != "" || $videocards->image != null? asset('src/images/products/'.$videocards->image):url('/noImg.png') }}" onerror="this.src='{{url('/noImg.png')}}'">
                                </div>
                        <form action="{{ route('product.addToCart', ['id'=>$videocards->item_id]) }}" method="GET">
                    @if($fromBuilder == null) 
                        <div class="row justify-content-center">
                                ...
                                <div class="spinner-control">
                                   <span style="margin-right: 5px">Qty: </span> 
                                        ...
                                        <input type="text" name="quantity" data-type="number" step="1" max="{{$videocards->quantity}}" min="1" value="1"  id="spinner1">
                                        ...
                                        <table class="table" style="text-align:center">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="color: white;">{{$videocards->brand_name}}</td>
                                                </tr>
                                                 <tr>
                                                ...
                                                <tr>
                                                    <td style="color: white;">GPU Brand</td>
                                                    <td style="color: white;">{{$videocards->gpu_brand}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Core Count</td>
                                                    <td style="color: white;">{{$videocards->core_count}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Clock Speed</td>
                                                    <td style="color: white;">{{$videocards->clock_speed}} MHz</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Memory Type</td>
                                                    <td style="color: white;">{{$videocards->memory_type}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Memory Size</td>
                                                    <td style="color: white;">{{$videocards->memory_size}} GB</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Memory Bandwidth</td>
                                                    <td style="color: white;">{{$videocards->memory_bandwidth}}-bit</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Thermal Design Power</td>
                                                    <td style="color: white;">{{$videocards->thermal_designpower}} Watts</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Power Connectors</td>
                                                    <td style="color: white;">{{$videocards->power_connectors}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Video Output Ports</td>
                                                    <td style="color: white;">{{$videocards->video_outputports}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">API Support</td>
                                                    <td style="color: white;">{{$videocards->api_support}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Computer Performance</td>
                                                    <td style="color: white;">{{$videocards->computer_performance}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">GPU Wattage</td>
                                                    <td style="color: white;">{{$videocards->gpu_wattage}} Watts</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">GPU Score</td>
                                                    <td style="color: white;">{{$videocards->gpu_score}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">GPU Description</td>
                                                    <td style="color: white;">{{$videocards->gpu_description}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Price</td>
                                                    <td style="color: white;">₱ {{ number_format($videocards->price, 2, '.', ',') }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Stocks</td>
                                                    <td style="color: white;">{{$videocards->quantity}}</td>
                                                </tr>
                                            </tbody>
                                                                                                {{-- REVIEW START --}}
                                     <thead style="background: #031131;color: rgb(248,249,255);">
