...
@include('partials.admin_header2')
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Add Video Card</h3>
                    </div>
                    <div style="background: rgb(230,247,236);padding: 11px;">
                        <h1 style="font-size: 23px;">Basic Info</h1>
            {{-- START --}}
                        {{Form::open(['url'=>route('videocard.store'), 'method'=> 'post', 'enctype' => 'multipart/form-data'])}}
                        @csrf
                            <div class="form-row">
        ...
        {{--  ADD ADDITIONAL INPUTS HERE --}}
                            ...
                            <div class="form-row">
                                ...
                                {{Form::label('Core Count:',null,['style'=>'color: rgb(0,0,0)'])}}<br>
                                    ...
                                    {{Form::number('core_count',null,['class'=>'form-control', 'step' => '1', 'min' => '1'])}}
