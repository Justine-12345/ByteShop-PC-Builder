    ...
    @include('partials.admin_header2')
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Add Power Supply</h3>
                    </div>
                    <div style="background: rgb(230,247,236);padding: 11px;">
                        <h1 style="font-size: 23px;">Basic Info</h1>
                        <form action="{{route('powersupply.store')}}" method="post" enctype="multipart/form-data">
                          @csrf
                           <div class="form-row">
                    ...
                    {{-- OTHER INFO --}}
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Wattage</label>
                                 <div class="form-group"><input class="form-control" type="number" name="wattage" min="1" max="1000" step="1" placeholder="0"value="{{old('wattage')}}"></div>
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Variable_rpmfan</label>
                                <div class="form-group">
                                        <input class="form-control" type="text" name="variable_rpmfan" value="{{old('variable_rpmfan')}}">
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Fan Size (mm)</label>
                                <div class="form-group">
                                        <input class="form-control" type="number" name="fan_size" min="1" max="1000" step="1" value="{{old('fan_size')}}">
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Power Supply Description</label>
                                 <div class="form-group">
                                        <input class="form-control" type="text" name="  powersupplies_description" value="{{old('   powersupplies_description')}}">
        ...
        </div><a class="border rounded d-inline scroll-to-top" href="#page-top"><i class="fas fa-arrow-left"></i></a>
    </div>
