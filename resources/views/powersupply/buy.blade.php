...
{{--      @include('partials.admin_header') --}}
  ...
  {{--   @include('partials.admin_header2') --}}
                ...
                {{-- MODIFY START --}}
                                ...
                                <div class="col">
                                <h1 class="col text-center" style="color: white;margin-top: 10px;">{{ucwords($powersupply->title)}} <br>{!!Star::display($review->review_rating)!!}</h1>
                                </div>
                                <div class="col text-center"><img style="color: rgb(133, 135, 150);border-radius: 5%;width: 300px;height: 300px;border: 10px solid #031131 ; margin: 20px;" src="{{$powersupply->image != "" || $powersupply->image != null? asset('src/images/products/'.$powersupply->image):url('/noImg.png') }}" onerror="this.src='{{url('/noImg.png')}}'">
                                </div>
                        <form action="{{ route('product.addToCart', ['id'=>$powersupply->item_id]) }}" method="GET">
                    @if($fromBuilder == null)
                        <div class="row justify-content-center">
                                ...
                                <div class="spinner-control">
                                   <span style="margin-right: 5px">Qty: </span> 
                                        ...
                                        <input type="text" name="quantity" data-type="number" step="1" max="{{$powersupply->quantity}}" min="1" value="1"  id="spinner1">
                                        ...
                                        <table class="table" style="text-align:center">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="color: white;">{{$powersupply->brand_name}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Price</td>
                                                    <td style="color: white;">₱ {{ number_format($powersupply->price, 2, '.', ',') }}</td>
                                                </tr>
                                                 <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="color: white;">{{$powersupply->quantity}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Form Factor</td>
                                                    <td style="color: white;">{{$powersupply->form_factor}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Wattage</td>
                                                    <td style="color: white;">{{$powersupply->wattage}} watts</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Efficiency Rating</td>
                                                    <td style="color: white;">{{$powersupply->efficiency_rating}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Rails</td>
                                                    <td style="color: white;">{{$powersupply->rails}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Protection</td>
                                                    <td style="color: white;">
                                                      @php 
                                                ...
                                                <tr>
                                                    <td style="color: white;">Modularity</td>
                                                    <td style="color: white;">{{$powersupply->modularity}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Variable_rpmfan</td>
                                                    <td style="color: white;">{{$powersupply->variable_rpmfan}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Fan Size</td>
                                                    <td style="color: white;">{{$powersupply->fan_size}} mm</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Description</td>
                                                    <td style="color: white;">{{$powersupply->powersupplies_description}}</td>
                                                </tr>
                                            </tbody>
                                                                                {{-- REVIEW START --}}
                                     <thead style="background: #031131;color: rgb(248,249,255);">
