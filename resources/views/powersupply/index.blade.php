...
@endif
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Power Supply</h3>
                    </div>
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive text-center">
                                        <table class="table">
                                            <thead style="background: #031131;">
                                                <tr>
                                                    ...
                                                    <th style="color: rgb(255,255,255);">Wattage</th>
                                        ...
                                        @foreach($powersupplies as $powersupply)
                                                <tr>
                                                    <td style="color: rgb(0,0,0);">{{$powersupply->powersupply_id}}<br></td>
                                                    <td style="color: rgb(0,0,0);"><img src="{{ asset('src/images/products/'.$powersupply->image) }}" width="100px" height="100px"></td></td>
                                                    <td style="color: rgb(0,0,0);">{{ucwords($powersupply->brand_name)}}</td>
                                                    <td style="color: rgb(0,0,0);">{{$powersupply->title}}<br></td>
                                                    <td style="color: rgb(0,0,0);">{{$powersupply->wattage}}<br></td>
                                                    <td style="color: rgb(0,0,0);">{{$powersupply->quantity}}<br></td>
                                                    <td style="color: rgb(0,0,0);">₱ {{ number_format($powersupply->price, 2, '.', ',') }}</td>

                                                 <td class="text-center">
                                                <form action="{{ action('PowersupplyController@destroy', $powersupply->item_id)}}" method="post">

                                                    <a href="{{ action('PowersupplyController@show', $powersupply->powersupply_id)}}" class="btn btn-primary" type="button" style="color: rgb(255, 255, 255);background: #00674c;"><i class="fa fa-eye"></i>&nbsp;View</a>

                                                    <a href="{{ action('PowersupplyController@edit', $powersupply->powersupply_id)}}" class="btn btn-primary" type="button" style="color: rgb(255, 255, 255);background: #00674c;"><i class="fa fa-eye"></i>&nbsp;Edit</a>
        ...
        </div><a class="border rounded d-inline scroll-to-top" href="{{route('powersupply.create')}}"><i class="fas fa-plus"></i></a>
    </div>
