...
@endif
                ...
                {{-- START LOOP HERE --}}
                                        @foreach($brands as $brand)
                                            <tr>
                                                <td style="color: rgb(0,0,0);">{{ $brand->brand_id }}</td>

                                                <td style="color: rgb(0,0,0);">{{ $brand->brand_name }}</td>

                                                <td style="color: rgb(0,0,0);">{{ $brand->category_name }}</td>

                                                <td class="text-center">
                                                <form action="{{ action('BrandController@destroy', $brand->brand_id)}}" method="post">

                                                    <a href="{{ action('BrandController@show', $brand->brand_id)}}" class="btn btn-primary" type="button" style="color: rgb(255, 255, 255);background: #00674c;"><i class="fa fa-eye"></i>&nbsp;View</a>

                                                    <a href="{{ action('BrandController@edit', $brand->brand_id)}}" class="btn btn-primary" type="button" style="color: rgb(255, 255, 255);background: #00674c;"><i class="fa fa-eye"></i>&nbsp;Edit</a>
        ...
        </div><a class="border rounded d-inline scroll-to-top" href="{{ route('brand.create') }}"><i class="fas fa-plus"></i></a>
    </div>
