...
<style type="text/css">
    option{
        ...
        <h1 style="padding-right: 35px;text-align: center; position: relative;">Sign Up</h1> 
   
<div class="row justify-content-center" style="position:relative; border: 0px solid white; width: 100%;"> 


<form action="{{ URL('user/signup') }}" method="post" style="width: 80%; padding: 20px;" enctype="multipart/form-data" > 
            @csrf
              @if (count($errors) > 0) 
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input type="text" id="addressline" name="addressline" class="form-control" value="{{old('addressline')}}">
