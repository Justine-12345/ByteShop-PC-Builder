            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Edit Memory</h3>
                    </div>
                    <div style="background: rgb(230,247,236);padding: 11px;">
                        <h1 style="font-size: 23px;">Basic Info</h1>
            {{-- START --}}
                        {{Form::model($item,array('route'=>array('memory.update',$item->memory_id), 'enctype' => 'multipart/form-data'))}}
                        {{method_field('PUT')}}
                        @csrf
                        {{-- {{dd($brands)}} --}}
                            <div class="form-row">
        ...
        {{--  ADD ADDITIONAL INPUTS HERE --}}
                            ...
                            <div class="form-row">
                                ...
                                {{Form::label('Memory Type:',null,['style'=>'color: rgb(0,0,0)'])}}<br>
                                    ...
                                    {{Form::select('memory_type',['ROM' => 'ROM','RAM' => 'RAM'],null,['class'=>'form-control'])}}
