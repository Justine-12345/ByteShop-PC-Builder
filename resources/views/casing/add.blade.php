    ...
    <div id="wrapper">
          ...
          @include('partials.admin_header2')
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Add Casings</h3>
                    </div>
                    <div style="background: rgb(230,247,236);padding: 11px;">
                        <h1 style="font-size: 23px;">Basic Info</h1>
            {{-- START --}}
                        <form method="post" action="{{ route('casing.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col">
                                    <label style="color: rgb(0,0,0);">Price:</label>
                                    <div class="form-group">
        ...
        {{--  ADD ADDITIONAL INPUTS HERE --}}
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Type:</label>
                                <div class="form-group">
                                    <input class="form-control" type="text" name="case_type" value="{{old('case_type')}}">
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Steel Thickness:</label>
                                <div class="form-group">
                                    <input class="form-control" type="text" name="steel_thickness" value="{{old('steel_thickness')}}">
                                </div>
                            </div>

                            <div class="col"><label style="color: rgb(0,0,0);">Motherboards:</label>
                                <div class="form-group">
                                    
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="Mini-ITX" name="case_motherboards[]">
                                        <label class="form-check-label" for="case_motherboards">Mini-ITX</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="MicroATX" name="case_motherboards[]">
                                        <label class="form-check-label" for="case_motherboards">MicroATX</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="ATX" name="case_motherboards[]">
                                        <label class="form-check-label" for="case_motherboards">ATX</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="EATX" name="case_motherboards[]">
                                        <label class="form-check-label" for="case_motherboards">EATX</label>
                                    </div>
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Width:</label>
                                <div class="form-group">
                                    <input class="form-control" type="text" name="case_width" value="{{old('case_width')}}">
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Height:</label>
                                <div class="form-group">
                                    <input class="form-control" type="text" name="case_height" value="{{old('case_height')}}">
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Depth:</label>
                                <div class="form-group">
                                    <input class="form-control" type="text" name="case_depth" value="{{old('case_depth')}}">
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Drive Bay 5.25:</label>
                                <div class="form-group">
                                    <input class="form-control" type="text" name="drivebay_5point25" value="{{old('drivebay_5point25')}}">
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Drive Bay 3.5:</label>
                                <div class="form-group">
                                    <input class="form-control" type="text" name="drivebay_3point5" value="{{old('drivebay_3point5')}}">
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Drive Bay 2.5:</label>
                                <div class="form-group">
                                    <input class="form-control" type="text" name="drivebay_2point5" value="{{old('drivebay_2point5')}}">
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Expansion Slot:</label>
                                <div class="form-group"><input class="form-control" type="text" name="expansion_slot" value="{{old('expansion_slot')}}"></div>
                            </div>

                            <div class="col"><label style="color: rgb(0,0,0);">Max PCI Slots:</label>
                                <div class="form-group"><input class="form-control" type="text" name="max_pcislots"value="{{old('max_pcislots')}}"></div>
                            </div>

                            <div class="col"><label style="color: rgb(0,0,0);">IO Ports:</label>
                                <div class="form-group"><input class="form-control" type="text" name="io_ports"value="{{old('io_ports')}}"></div>
                            </div>

                            <div class="col"><label style="color: rgb(0,0,0);">Height of Coolers:</label>
                                <div class="form-group"><input class="form-control" type="text" name="height_coolers" value="{{old('height_coolers')}}"></div>
                            </div>

                            <div class="col"><label style="color: rgb(0,0,0);">Air Cooling System:</label>
                                <div class="form-group"><input class="form-control" type="text" name="aircooling_system" value="{{old('aircooling_system')}}"></div>
                            </div>

                            <div class="col"><label style="color: rgb(0,0,0);">Net Weight:</label>
                                <div class="form-group"><input class="form-control" type="text" name="net_weight" value="{{old('net_weight')}}"></div>
                            </div>

                            <div class="col"><label style="color: rgb(0,0,0);">Description:</label>
                                <div class="form-group"><input class="form-control" type="text" name="casing_description" value="{{old('casing_description')}}"></div>
                            </div>
