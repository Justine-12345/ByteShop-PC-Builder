...
<body id="page-top">
         ...
         @include('partials.admin_header2')
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Edit mouse</h3>
                    </div>
                    <div style="background: rgb(230,247,236);padding: 11px;">
                        <h1 style="font-size: 23px;">Basic Info</h1>
                       
                         {{-- START --}}
                        <form method="post" action="{{ route('printer.update', $printers[0]->item_id) }}" enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PATCH') }}
                            ...
                            <div class="form-row">
                                        ...
                                        <select class="form-control" name="brand_id">
                                            <optgroup label="Brand Names">
                                                ...
                                                @foreach($brands as $brand)
                                                    @if( $printers[0]->brand_id == $brand->brand_id)
                                ...
                                <div class="col"><label style="color: rgb(0,0,0);">Title:</label>
                                    <div class="form-group">
                                        <input class="form-control" type="text" name="title" value="{{ $printers[0]->title }}">
                            ...
                            <div class="form-row">
                                <div class="col"><label style="color: rgb(0,0,0);">Stock:&nbsp;</label>
                                    <div class="form-group">
                                        <input class="form-control" type="number" min="1" max="1000000" step="1" placeholder="No. of Stocks" name="quantity" value="{{ $printers[0]->quantity }}">
                                ...
                                <div class="col"><label style="color: rgb(0,0,0);">Price:</label>
                                    <div class="form-group">
                                        <input class="form-control" type="number" name="price" value="{{ $printers[0]->price }}">
   ...
   <div class="col"><label style="color: rgb(0,0,0);">Printer Type:</label>
                             <div class="form-group">
                                    @if($printers[0]->printer_type == 'Inkjet')
                                    ...
                                    @elseif($printers[0]->printer_type == 'Laser')
                                        <div class="form-check form-check-inline">
  ...
  <div class="col"><label style="color: rgb(0,0,0);">Ink Type:</label>
                                <div class="form-group">
                                    @if($printers[0]->ink_type == 'Monochrome')
                                        <div class="form-check form-check-inline">
                                    ...
                                    @elseif($printers[0]->ink_type == 'Color')
                                        <div class="form-check form-check-inline">
     ...
     <div class="col"><label style="color: rgb(0,0,0);">All in One:</label>
                                <div class="form-group">
                                    @if($printers[0]->all_inOne == 'Printer Only')
                                        <div class="form-check form-check-inline">
                                    ...
                                    @elseif($printers[0]->all_inOne == 'All-in-One Printer')
                                        <div class="form-check form-check-inline">
                                  ...
                                  <div class="col"><label style="color: rgb(0,0,0);">Printer Speed:&nbsp;</label>
                                    <div class="form-group">
                                        <input class="form-control" type="text" placeholder="Printer Speed in ppm" name="print_speed" value="{{ $printers[0]->print_speed}}">
                                ...
                                <div class="form-group">
                                    @if( $printers[0]->duplex_support == 'Single-engine Duplex')
                                        <div class="form-check form-check-inline">
                                    ...
                                    @elseif($printers[0]->duplex_support == 'Double-engine Duplex')
                                        <div class="form-check form-check-inline">
                             ...
                             <div class="col"><label style="color: rgb(0,0,0);">Feeder:</label>
                                <div class="form-group">
                                    ...
                                    <option  value="{{ $printers[0]->automatic_feed }}" selected >{{ $printers[0]->automatic_feed }}</option>
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">DPI:</label>
                                <div class="form-group">
                                    <input class="form-control" type="text" name="dpi" value="{{ $printers[0]->dpi }}">
    ...
    <div class="col"><label style="color: rgb(0,0,0);">Paper Capacity:</label>
                                <div class="form-group"><input class="form-control" type="text" placeholder="No. of sheets" name="paper_capacity" value="{{ $printers[0]->paper_capacity }}"></div>
                            </div>

                             <div class="col"><label style="color: rgb(0,0,0);">Duty Cycles:</label>
                                <div class="form-group"><input class="form-control" type="text" placeholder="No. of sheets" name="duty_cycle" value="{{ $printers[0]->duty_cycle }}"></div>
                            </div>

                             <div class="col"><label style="color: rgb(0,0,0);">Cartridge Capacity:</label>
                                <div class="form-group"><input class="form-control" type="text" placeholder="No. of pages" name="catridge_capacity" value="{{ $printers[0]->catridge_capacity }}"></div>
                            </div>
                             ...
                             <div class="col"><label style="color: rgb(0,0,0);">Connectivity:</label>
                                <div class="form-group">
                                    @foreach($connection_interface_formfactors as $connection_interface_formfactor)
                                        @if(in_array($connection_interface_formfactor, $connection_interface))
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="{{ $connection_interface_formfactor }}" name="connection_interface[]" checked="">
                                                <label class="form-check-label" for="connection_interface">{{ $connection_interface_formfactor }}</label>
                                            </div>
                                        @elseif($connection_interface_formfactor != '')
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="{{ $connection_interface_formfactor}}" name="connection_interface[]">
                                                <label class="form-check-label" for="connection_interface">{{ $connection_interface_formfactor }}</label>
                                            </div>
                                        @endif
                                    @endforeach
                               ...
                               <div class="col"><label style="color: rgb(0,0,0);">Scanner Resolution:</label>
                                <div class="form-group">
                                    <input class="form-control" type="text" name="scanner_resolution" placeholder="Scanner Resolution in DPI" value="{{ $printers[0]->scanner_resolution }}">
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Copy Speed:</label>
                                <div class="form-group">
                                    <input class="form-control" type="text" name="copy_speed" placeholder="Copy speed in ppm" value="{{ $printers[0]->copy_speed }}">
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Printer Memory:</label>
                                <div class="form-group">
                                    ...
                                    <option value="{{ $printers[0]->printer_memory }}" selected="">{{ $printers[0]->printer_memory }}</option>
                               ...
                               <div class="col"><label style="color: rgb(0,0,0);">Security and Encryption:</label>
                                <div class="form-group">
                                    ...
                                    <option value="{{ $printers[0]->encryption_support }}" selected>{{ $printers[0]->encryption_support }}</option>
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Description:</label>
                                <div class="form-group"><input class="form-control" type="text" name="printer_description" value="{{ $printers[0]->printer_description }}"></div>
                            </div>
