...
{{--      @include('partials.admin_header') --}}
  ...
  {{--   @include('partials.admin_header2') --}}
                ...
                {{-- MODIFY START --}}
                                <div class="col">
                                <h1 class="col text-center" style="color: white;margin-top: 10px;">{{ucwords($motherboards[0]->title)}} <br>{!!Star::display($review->review_rating)!!}</h1>
                                </div>
                                <div class="col text-center"><img style="color: rgb(133, 135, 150);border-radius: 5%;width: 300px;height: 300px;border: 10px solid #031131 ; margin: 20px;" src="{{$motherboards[0]->image != "" || $motherboards[0]->image != null? asset('src/images/products/'.$motherboards[0]->image):url('/noImg.png') }}" onerror="this.src='{{url('/noImg.png')}}'">
                                </div>
                        <form action="{{ route('product.addToCart', ['id'=>$motherboards[0]->item_id]) }}" method="GET">
                     @if($fromBuilder == null)    
                        <div class="row justify-content-center">
                                ...
                                <div class="spinner-control">
                                   <span style="margin-right: 5px">Qty: </span> 
                                        ...
                                        <input type="text" name="quantity" data-type="number" step="1" max="{{ $motherboards[0]->quantity }}" min="1" value="1"  id="spinner1">
                                        ...
                                        <table class="table" style="text-align:center;">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="color: white;">{{ $motherboards[0]->brand_name }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Category</td>
                                                    <td style="color: white;">{{ $motherboards[0]->category_name }}</td>
                                                </tr>
                                                 <tr>
                                                ...
                                                <tr>
                                                    <td style="color: white;">Form Factor</td>
                                                    <td style="color: white;">{{ $motherboards[0]->form_factor }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">CPU Socket</td>
                                                    <td style="color: white;">{{ $motherboards[0]->cpu_socket }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">USB Ports</td>
                                                    <td style="color: white;">{{ $motherboards[0]->usb_ports }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">RAM Slot</td>
                                                    <td style="color: white;">{{ $motherboards[0]->ram_slot }}</td>
                                                </tr>
                                                 <tr>
                                                    @php
                                                    $video_connectors = explode(" | ",  $motherboards[0]->video_connectors);
                                                    @endphp
                                                    <td style="color: white;">Video Connector</td>
                                                    <td style="color: white;">
                                                ...
                                                <tr>
                                                    <td style="color: white;">PCIE Slots </td>
                                                    <td style="color: white;">{{ $motherboards[0]->pcie_slots}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Onboard Wi-Fi Support </td>
                                                    <td style="color: white;">{{ $motherboards[0]->inbuilt_wifi}}</td>
                                                </tr>

                                                <tr>
                                                    <td style="color: white;">Sata</td>
                                                    <td style="color: white;">{{ $motherboards[0]->sata}}</td>
                                                </tr>

                                                <tr>
                                                    <td style="color: white;">M.2 Nvme Support </td>
                                                    <td style="color: white;">{{ $motherboards[0]->nvme_support}}</td>
                                                </tr>
                                               <tr>
                                                    <td style="color: white;">RGB Headers </td>
                                                    <td style="color: white;">{{ $motherboards[0]->rgb_header}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Description</td>
                                                    <td style="color: white;">{{ $motherboards[0]->motherboard_description }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Stocks</td>
                                                    <td style="color: white;">{{ $motherboards[0]->quantity }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Price</td>
                                                    <td style="color: white;">₱ {{ number_format($motherboards[0]->price, 2, '.', ',') }}</td>
                                                </tr>
                                            </tbody>
                                                                                {{-- REVIEW START --}}
                                     <thead style="background: #031131;color: rgb(248,249,255);">
