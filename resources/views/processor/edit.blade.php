    ...
    @include('partials.admin_header2')
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Edit Processors</h3>
                    </div>
                    <div style="background: rgb(230,247,236);padding: 11px;">
                        <h1 style="font-size: 23px;">Basic Info</h1>
                        <form  action="{{ route('processor.update', $processor->item_id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PATCH') }}
                            <div class="form-row">
                                            ...
                                            <optgroup label="Brand Names">
                                                <option value="">Select Brand</option>
                                                  ...
                                                  @foreach($brands as $brand)
                                                    @if( $processor->brand_id == $brand->brand_id)
                                ...
                                <div class="col"><label style="color: rgb(0,0,0);">Title:</label>
                                    <div class="form-group">
                                        <input class="form-control" type="text" name="title" value="{{old('title')?old('title'):$processor->title}}">
                             ...
                             <div class="form-row">
                                <div class="col"><label style="color: rgb(0,0,0);">Stock:&nbsp;</label>
                                    <div class="form-group">
                                        <input class="form-control" type="number" min="1" max="1000000" step="1" placeholder="No. of Stocks" name="quantity" value="{{old('quantity')?old('quantity'):$processor->quantity}}">
                                ...
                                <div class="col"><label style="color: rgb(0,0,0);">Price:</label>
                                    <div class="form-group">
                                        <input class="form-control" type="number" name="price" value="{{old('price')?old('price'):$processor->price}}" step="1" min="1" max="1000000">
                    ...
                    {{-- OTHER INFO --}}
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Base Speed (GHz)</label>
                               <div class="form-group"><input class="form-control" type="number" name="base_speed" min=".1" max="8" step=".1" placeholder="0.0" value="{{old('base_speed')?old('base_speed'):$processor->base_speed}}"></div>
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Max Speed (GHz)</label>
                               <div class="form-group"><input class="form-control" type="number" name="max_speed" min=".1" max="8" step=".1" placeholder="0.0" value="{{old('max_speed')?old('max_speed'):$processor->max_speed}}"></div>
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Overclocking (GHz)</label>
                                <div class="form-group"><input class="form-control" type="number" name="overclocking" min=".1" max="8" step=".1" placeholder="0.0" value="{{old('overclocking')?old('overclocking'):$processor->overclocking}}"></div>
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Core Count</label>
                                <div class="form-group"><input class="form-control" type="number" name="core_count" min="1" step="1" placeholder="0"value="{{old('core_count')?old('core_count'):$processor->core_count}}"></div>
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Thread Count</label>
                                <div class="form-group"><input class="form-control" type="number" name="multi_threading" min="1" step="1" placeholder="0" value="{{old('multi_threading')?old('multi_threading'):$processor->multi_threading}}"></div>
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Cache</label>
                                <div class="form-group"><input class="form-control" type="text" name="cache" value="{{old('cache')?old('cache'):$processor->cache}}"></div>
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Memory Type</label>
                                 <select name="memory_type" class="form-control" >
                                    ...
                                    @else
                                     <option value="{{$processor->memory_type}}" selected>{{$processor->memory_type}}</option>
                                    @endif
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Socket Type</label>
                                <div class="form-group">
                                    ...
                                    @else
                                     <option value="{{$processor->socket_type}}" selected>{{$processor->socket_type}}</option>
                                    @endif 
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">TDP Rating (Watts)</label>
                               <div class="form-group"><input class="form-control" type="number" name="tdp_rating" min="1" step="1" placeholder="0"value="{{old('tdp_rating')?old('tdp_rating'):$processor->tdp_rating}}"></div>
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Fabcrication (nm)</label>
                                 <div class="form-group"><input class="form-control" type="number" name="fabrication" min="1" step="1" placeholder="0"value="{{old('fabrication')?old('fabrication'):$processor->fabrication}}"></div>
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Integrated Graphics&nbsp;</label>
                               <div class="form-group"><input class="form-control" type="text" name="ingrated_graphics" value="{{old('ingrated_graphics')?old('ingrated_graphics'):$processor->ingrated_graphics}}"></div>
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Processor Wattage (Watts)</label>
                                <div class="form-group"><input class="form-control" type="number" name="processor_wattage" min="1" max="1000" step="1" placeholder="0" value="{{old('processor_wattage')?old('processor_wattage'):$processor->processor_wattage}}"></div>
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Processor Score</label>
                                 <div class="form-group"><input class="form-control" type="number" name="processor_score" min="1" max="100" step="1" placeholder="0" value="{{old('processor_score')?old('processor_score'):$processor->processor_score}}"></div>
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Processor Description</label>
                               <div class="form-group"><input class="form-control" type="text" name="processor_description" value="{{old('processor_description')?old('processor_description'):$processor->processor_description}}"></div>
