...
<a class='holo-btn-fed text-center' href='{{route('pc.getPrebuilt')}}'>
    <span class='cta-d' style="margin-bottom: 5px"><i class="fas fa-box-open"></i>  Pre-built PC</span>
    <span class='skew top'></span>
    <span class='skew bottom'></span>
</a> 
@endif
...
<div class="row text-center" style="width: 100%">
    <div class="col">
      <h3>{{auth()->user()->name}} Build List </h3>  
    </div>
</div>
...
<div class="row justify-content-center" style="width: 100%;">
    @foreach($builds as $build)
        ...
        <div class="col-lg-8" style="margin:auto; margin-bottom: 30px; border:0px solid white" >
