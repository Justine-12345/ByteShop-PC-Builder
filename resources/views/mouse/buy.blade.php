...
{{--      @include('partials.admin_header') --}}
  ...
  {{--   @include('partials.admin_header2') --}}
                ...
                {{-- MODIFY START --}}
                                <div class="col">
                                <h1 class="col text-center" style="color: white;margin-top: 10px;">{{ucwords($mouses[0]->title)}} <br>{!!Star::display($review->review_rating)!!}</h1>
                                </div>
                                <div class="col text-center"><img style="color: rgb(133, 135, 150);border-radius: 5%;width: 300px;height: 300px;border: 10px solid #031131 ; margin: 20px;" src="{{$mouses[0]->image != "" || $mouses[0]->image != null? asset('src/images/products/'.$mouses[0]->image):url('/noImg.png') }}" onerror="this.src='{{url('/noImg.png')}}'">
                                </div>
                        <form action="{{ route('product.addToCart', ['id'=>$mouses[0]->item_id]) }}" method="GET">
                     @if($fromBuilder == null)
                        <div class="row justify-content-center">
                                ...
                                <div class="spinner-control">
                                   <span style="margin-right: 5px">Qty: </span> 
                                        ...
                                        <input type="text" name="quantity" data-type="number" step="1" max="{{ $mouses[0]->quantity }}" min="1" value="1"  id="spinner1">
                                        ...
                                        <table class="table" style="text-align: center;">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="color: white;">{{ $mouses[0]->brand_name }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Category</td>
                                                    <td style="color: white;">{{ $mouses[0]->category_name }}</td>
                                                </tr>
                                                 <tr>
                                                ...
                                                <tr>
                                                    <td style="color: white;">Sensor</td>
                                                    <td style="color: white;">{{ $mouses[0]->sensor }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">DPI</td>
                                                    <td style="color: white;">{{ $mouses[0]->dpi }} DPI</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Poll Rate</td>
                                                    <td style="color: white;">{{ $mouses[0]->poll_rate }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Tracking Speed</td>
                                                    <td style="color: white;">{{ $mouses[0]->tracking_speed }}</td>
                                                </tr>
                                                 <tr>
                                                    <td style="color: white;">Build Type</td>
                                                    <td style="color: white;">{{ $mouses[0]->build_type}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Wired</td>
                                                    <td style="color: white;">{{ $mouses[0]->mouse_wired}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Programmable Button</td>
                                                    <td style="color: white;">{{ $mouses[0]->programmable_button }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Weight Customization</td>
                                                    <td style="color: white;">{{ $mouses[0]->weight_customization }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Lift off Distance</td>
                                                    <td style="color: white;">{{ $mouses[0]->liftoff_distance }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Angle Snapping</td>
                                                    <td style="color: white;">{{ $mouses[0]->angle_snapping}}</td>
                                                </tr>
                                               
                                                <tr>
                                                    <td style="color: white;">Description</td>
                                                    <td style="color: white;">{{ $mouses[0]->mouse_description }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Stocks</td>
                                                    <td style="color: white;">{{ $mouses[0]->quantity }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Price</td>
                                                    <td style="color: white;">₱ {{ number_format($mouses[0]->price, 2, '.', ',') }}</td>
                                                </tr>
                                            </tbody>
                                                                               {{-- REVIEW START --}}
                                     <thead style="background: #031131;color: rgb(248,249,255);">
