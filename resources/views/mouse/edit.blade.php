...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div style="background: rgb(230,247,236);padding: 11px;">
                        <h1 style="font-size: 23px;">Basic Info</h1>
                         ...
                         {{-- START --}}
                        <form method="post" action="{{ route('mouse.update', $mouses[0]->item_id) }}" enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PATCH') }}
                            ...
                            <div class="form-row">
                                        ...
                                        <select class="form-control" name="brand_id">
                                            <optgroup label="Brand Names">
                                                ...
                                                @foreach($brands as $brand)
                                                    @if( $mouses[0]->brand_id == $brand->brand_id)
                                ...
                                <div class="col"><label style="color: rgb(0,0,0);">Title:</label>
                                    <div class="form-group">
                                        <input class="form-control" type="text" name="title" value="{{ $mouses[0]->title }}">
                            ...
                            <div class="form-row">
                                <div class="col"><label style="color: rgb(0,0,0);">Stock:&nbsp;</label>
                                    <div class="form-group">
                                        <input class="form-control" type="number" min="1" max="1000000" step="1" placeholder="No. of Stocks" name="quantity" value="{{ $mouses[0]->quantity }}">
                                ...
                                <div class="col"><label style="color: rgb(0,0,0);">Price:</label>
                                    <div class="form-group">
                                        <input class="form-control" type="number" name="price" value="{{ $mouses[0]->price }}">
 ...
 <div class="col"><label style="color: rgb(0,0,0);">Sensor:</label>
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">DPI:</label>
                                <div class="form-group">
                                    <input class="form-control" type="text" name="dpi" value="{{ $mouses[0]->dpi }}">
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Poll Rate:</label>
                                <div class="form-group">
                                    ...
                                    {{--       @if( $mouses[0]->poll_rate == $brand->brand_id)
                                                        <option value="{{ $brand->brand_id }}" selected="">{{ $brand->brand_name }}</option>
                                                    @else
                                                        <option value="{{ $brand->brand_id }}">{{ $brand->brand_name }}</option>
                                                    @endif --}}
                                    <option  value="{{ $mouses[0]->poll_rate }}" selected >{{ $mouses[0]->poll_rate }}</option>
                                    <option value="8000Hz" s>8000Hz</option>
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Tracking Speed:</label>
                                <div class="form-group">
                                    ...
                                    <option value="{{ $mouses[0]->tracking_speed }}" selected >{{ $mouses[0]->tracking_speed }}</option>
                                ...
                                <div class="form-group">
                                     ...
                                     <option value="{{ $mouses[0]->build_type }}" selected >{{ $mouses[0]->build_type }}</option>
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Wired:</label>
                                <div class="form-group">
                                    ...
                                    @elseif($mouses[0]->mouse_wired == 'No')
                                        <div class="form-check form-check-inline">
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Programmable Buttons:</label>
                                <div class="form-group">
                                    @if($mouses[0]->programmable_button == 'Yes')
                                        <div class="form-check form-check-inline">
                                    ...
                                    @elseif($mouses[0]->programmable_button  == 'No')
                                        <div class="form-check form-check-inline">
                             ...
                             <div class="col"><label style="color: rgb(0,0,0);">Weight:</label>
                                <div class="form-group"><input class="form-control" type="text" name="weight_customization" value="{{ $mouses[0]->weight_customization }}"></div>
                            </div>
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Lift Off Distance:</label>
                                <div class="form-group">
                                    @if($mouses[0]->liftoff_distance == 'High')
                                        <div class="form-check form-check-inline">
                                    ...
                                    @elseif($mouses[0]->liftoff_distance == 'Low')
                                        <div class="form-check form-check-inline">
...
<div class="col"><label style="color: rgb(0,0,0);">Angle Snapping:</label>
                                <div class="form-group">
                                    @if($mouses[0]->angle_snapping == 'Yes')
                                        <div class="form-check form-check-inline">
                                    ...
                                    @elseif($mouses[0]->angle_snapping== 'No')
                                        <div class="form-check form-check-inline">
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Description:</label>
                                <div class="form-group"><input class="form-control" type="text" name="mouse_description" value="{{ $mouses[0]->mouse_description }}"></div>
                            </div>
