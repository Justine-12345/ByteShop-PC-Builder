    ...
    @include('partials.admin_header2')
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Add Keyboards</h3>
                    </div>
                    <div style="background: rgb(230,247,236);padding: 11px;">
                        <h1 style="font-size: 23px;">Basic Info</h1>
            {{-- START --}}
                        <form method="post" action="{{ route('keyboard.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-row">
        ...
        {{--  ADD ADDITIONAL INPUTS HERE --}}
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Width (inches):</label>
                                <div class="form-group">
                                    <input class="form-control" type="text" name="keyboard_width" value="{{old('keyboard_width')}}">
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Length (inches):</label>
                                <div class="form-group">
                                    <input class="form-control" type="text" name="keyboard_length" value="{{old('keyboard_length')}}">
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Depth (inches):</label>
                                <div class="form-group">
                                    <input class="form-control" type="text" name="keyboard_depth" value="{{old('keyboard_depth')}}">
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Weight(pounds):</label>
                                <div class="form-group"><input class="form-control" type="text" name="keyboard_weight" value="{{old('keyboard_weight')}}"></div>
                            </div>

                            <div class="col"><label style="color: rgb(0,0,0);">Wired:</label>
                                <div class="form-group">
                                    @if(old('keyboard_wired') == 'Yes')
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Style of Keys:</label>
                                <div class="form-group"><input class="form-control" type="text" name="style_keys" value="{{old('style_keys')}}"></div>
                            </div>

                            <div class="col"><label style="color: rgb(0,0,0);">Full Keyboard:</label>
                                <div class="form-group"><input class="form-control" type="text" name="full_keyboard" value="{{old('full_keyboard')}}"></div>
                            </div>

                            <div class="col"><label style="color: rgb(0,0,0);">Color:</label>
                                <div class="form-group"><input class="form-control" type="text" name="color"value="{{old('color')}}"></div>
                            </div>

                            <div class="col"><label style="color: rgb(0,0,0);">Battery:</label>
                                <div class="form-group"><input class="form-control" type="text" name="battery"value="{{old('battery')}}"></div>
                            </div>

                            <div class="col"><label style="color: rgb(0,0,0);">Extra Features:</label>
                                <div class="form-group"><input class="form-control" type="text" name="extra_features" value="{{old('extra_features')}}"></div>
                            </div>

                            <div class="col"><label style="color: rgb(0,0,0);">Layout:</label>
                                <div class="form-group"><input class="form-control" type="text" name="keyboard_layout" value="{{old('keyboard_layout')}}"></div>
                            </div>

                            <div class="col"><label style="color: rgb(0,0,0);">Description:</label>
                                <div class="form-group"><input class="form-control" type="text" name="keyboard_description" value="{{old('keyboard_description')}}"></div>
                            </div>
