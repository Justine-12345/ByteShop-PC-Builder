...
{{--      @include('partials.admin_header') --}}
  ...
  {{--   @include('partials.admin_header2') --}}
                ...
                {{-- MODIFY START --}}
                                ...
                                <div class="col">
                                <h1 class="col text-center" style="color: white;margin-top: 10px;">{{ucwords($harddrives[0]->title)}} <br>{!!Star::display($review->review_rating)!!}</h1>
                                </div>
                                <div class="col text-center"><img style="color: rgb(133, 135, 150);border-radius: 5%;width: 300px;height: 300px;border: 10px solid #031131 ; margin: 20px;" src="{{$harddrives[0]->image != "" || $harddrives[0]->image != null? asset('src/images/products/'.$harddrives[0]->image):url('/noImg.png') }}" onerror="this.src='{{url('/noImg.png')}}'">
                                </div>
                        <form action="{{ route('product.addToCart', ['id'=>$harddrives[0]->item_id]) }}" method="GET">
                        ...
                        <div class="row justify-content-center">
                                ...
                                <div class="spinner-control">
                                   <span style="margin-right: 5px">Qty: </span> 
                                        ...
                                        <input type="text" name="quantity" data-type="number" step="1" max="{{ $harddrives[0]->quantity }}" min="1" value="1"  id="spinner1">
                                        ...
                                        <table class="table" style="text-align:center;">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="color: white;">{{ $harddrives[0]->brand_name }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Category</td>
                                                    <td style="color: white;">{{ $harddrives[0]->category_name }}</td>
                                                </tr>
                                                 <tr>
                                                ...
                                                <tr>
                                                    <td style="color: white;">Storage Type</td>
                                                    <td style="color: white;">{{ $harddrives[0]->storage_type }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Capacity</td>
                                                    <td style="color: white;">{{ 
                                                        $converter->translate($harddrives[0]->capacity)}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Rotational Speed</td>
                                                    <td style="color: white;">{{ $harddrives[0]->rotational_speed }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Transfer Rate</td>
                                                    <td style="color: white;">{{ $harddrives[0]->transfer_rate }}MBps</td>
                                                </tr>
                                                 <tr>
                                                    <td style="color: white;">Cache Size</td>
                                                    <td style="color: white;">{{ $harddrives[0]->cache_size}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Power</td>
                                                    <td style="color: white;">{{ $harddrives[0]->power}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Height</td>
                                                    <td style="color: white;">{{ $harddrives[0]->height}}</td>
                                                </tr>

                                                <tr>
                                                    <td style="color: white;">Depth</td>
                                                    <td style="color: white;">{{ $harddrives[0]->dept}}</td>
                                                </tr>

                                                <tr>
                                                    <td style="color: white;">Width</td>
                                                    <td style="color: white;">{{ $harddrives[0]->width}}</td>
                                                </tr>
                                               <tr>
                                                    <td style="color: white;">Weight</td>
                                                    <td style="color: white;">{{ $harddrives[0]->weight}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Description</td>
                                                    <td style="color: white;">{{ $harddrives[0]->harddrive_description }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Stocks</td>
                                                    <td style="color: white;">{{ $harddrives[0]->quantity }}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color: white;">Price</td>
                                                    <td style="color: white;">₱ {{ number_format($harddrives[0]->price, 2, '.', ',') }}</td>
                                                </tr>
                                            </tbody>
                                                                                  {{-- REVIEW START --}}
                                     <thead style="background: #031131;color: rgb(248,249,255);">
