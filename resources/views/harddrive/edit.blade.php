            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Edit Hard Drive</h3>
                    </div>
                    <div style="background: rgb(230,247,236);padding: 11px;">
                        <h1 style="font-size: 23px;">Basic Info</h1>
                       
                         {{-- START --}}
                        <form method="post" action="{{ route('harddrive.update', $harddrives[0]->item_id) }}" enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PATCH') }}
                            ...
                            <div class="form-row">
                                        ...
                                        <select class="form-control" name="brand_id">
                                            <optgroup label="Brand Names">
                                                ...
                                                @foreach($brands as $brand)
                                                    @if( $harddrives[0]->brand_id == $brand->brand_id)
                                ...
                                <div class="col"><label style="color: rgb(0,0,0);">Title:</label>
                                    <div class="form-group">
                                        <input class="form-control" type="text" name="title" value="{{ $harddrives[0]->title }}">
                            ...
                            <div class="form-row">
                                <div class="col"><label style="color: rgb(0,0,0);">Stock:&nbsp;</label>
                                    <div class="form-group">
                                        <input class="form-control" type="number" min="1" max="1000000" step="1" placeholder="No. of Stocks" name="quantity" value="{{ $harddrives[0]->quantity }}">
                                ...
                                <div class="col"><label style="color: rgb(0,0,0);">Price:</label>
                                    <div class="form-group">
                                        <input class="form-control" type="number" name="price" value="{{ $harddrives[0]->price }}">
        ...
        {{--  ADD ADDITIONAL INPUTS HERE --}}
                         ...
                         <div class="col"><label style="color: rgb(0,0,0);">Storage Type:</label>
                                <div class="form-group">
                                    ...
                                    <option selected value="{{$harddrives[0]->storage_type}}"> {{$harddrives[0]->storage_type}}</option>
                         ...
                         <div class="col"><label style="color: rgb(0,0,0);">Capacity:</label>
                                <div class="form-group">
                                    {{-- <input class="form-control" type="text" name="poll_rate" value="{{old('poll_rate')}}"> --}}
                                     ...
                                     <select name="capacity" class="form-control" >
                                         <option selected value="{{$harddrives[0]->capacity}}"> {{$converter->translate($harddrives[0]->capacity)}}</option>
                             ...
                             <div class="col"><label style="color: rgb(0,0,0);">Rotational speed:</label>
                                <div class="form-group">
                                    ...
                                    @else
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="rotational_speed" id="inlineRadio1" value="4200 RPM" {{$harddrives[0]->rotational_speed == '4200 RPM' ?  'checked' : null}}>
                                            <label class="form-check-label" for="inlineRadio1">4200 RPM</label>
                                        </div>

                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="rotational_speed" id="inlineRadio1" value="5200 RPM" {{$harddrives[0]->rotational_speed == '5200 RPM' ?  'checked' : null}}>
                                            <label class="form-check-label" for="inlineRadio1">5200 RPM</label>
                                        </div>

                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="rotational_speed" id="inlineRadio1" value="5400 RPM" {{$harddrives[0]->rotational_speed == '5400 RPM' ?  'checked' : null}}>
                                            <label class="form-check-label" for="inlineRadio1">5400 RPM</label>
                                        </div>

                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="rotational_speed" id="inlineRadio1" value="7200 RPM" {{$harddrives[0]->rotational_speed == '7200 RPM' ?  'checked' : null}}>
                                            <label class="form-check-label" for="inlineRadio1">7200 RPM</label>
                                        </div>

                                          <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="rotational_speed" id="inlineRadio1" value="10000 RPM" {{$harddrives[0]->rotational_speed == '10000 RPM' ?  'checked' : null}}>
                                            <label class="form-check-label" for="inlineRadio1">10000 RPM</label>
                                        </div>

                                          <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="rotational_speed" id="inlineRadio1" value="15000 RPM" {{$harddrives[0]->rotational_speed == '15000 RPM' ?  'checked' : null}}>
                                            <label class="form-check-label" for="inlineRadio1">15000 RPM</label>
                                        </div>
                                    @endif
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Connectivity Type:</label>
                                <div class="form-group">
                                    ...
                                    <select name="connectivity_type" class="form-control" >
                                        <option {{$harddrives[0]->connectivity_type}} selected> {{$harddrives[0]->connectivity_type}}</option>
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Transfer rate(MBps):</label>
                                <div class="form-group"><input class="form-control" type="number" name="transfer_rate" min="1" value="{{old('transfer_rate') ? old('transfer_rate') : $harddrives[0]->transfer_rate}}"></div>

                                @if($errors->has('transfer_rate'))
                                    <small><i style="color:red;">*{{ $errors->first('transfer_rate') }}</i></small>
                                        @endif
                                    </div>
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Cache Size:</label>
                                <div class="form-group">
                                    ...
                                    <select name="cache_size" class="form-control" >
                                        <option selected value=" {{$harddrives[0]->cache_size}}"> {{$harddrives[0]->cache_size}}</option>
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Power:</label>
                                <div class="form-group">
                                    ...
                                    @elseif($harddrives[0]->power  == '12 Volts')
                                        <div class="form-check form-check-inline">
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Height:</label>
                                <div class="form-group">
                                    ...
                                    <select name="height" class="form-control" >
                                        <option value="{{$harddrives[0]->height}}" selected> {{$harddrives[0]->height}}</option>
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Depth:</label>
                                <div class="form-group"><input class="form-control" type="text" name="depth" value="{{old('depth') ? old('depth') : $harddrives[0]->dept }}"></div>
                                @if($errors->has('depth'))
                                    <small><i style="color:red;">*{{ $errors->first('depth') }}</i></small>
                                        @endif
                                    </div>
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Width:</label>
                                <div class="form-group">
                                    ...
                                    <select name="width" class="form-control" >
                                        <option value="{{$harddrives[0]->width}}" selected> {{$harddrives[0]->width}}</option>
                            ...
                            <div class="form-group">
                                <input class="form-control" type="text" name="weight" value="{{old('weight') ? old('weight') : $harddrives[0]->weight}}"></div>
                            ...
                            <div class="col"><label style="color: rgb(0,0,0);">Description:</label>
                                <div class="form-group"><input class="form-control" type="text" name="harddrive_description" value="{{old('harddrive_description')?old('harddrive_description') : $harddrives[0]->harddrive_description}}"></div>
                            </div>
